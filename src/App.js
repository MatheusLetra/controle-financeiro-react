...
const App = () => {
  const data = localStorage.getItem('transactions-controle-financeiro')
  ...
  const handleAdd = (transaction) => {
    ...
    localStorage.setItem('transactions-controle-financeiro', JSON.stringify(newArrayTransactions))
  }
